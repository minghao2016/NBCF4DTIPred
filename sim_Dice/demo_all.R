...
rm(list = ls())
setwd("C:\\Users\\kevin\\Desktop\\NBCF4DTIPred-master\\sim_Dice") ## change to the direcotry including all source codes and datasets
source("ppmiCFDTI.R")
...
## make picture, adding dice similarity

rm(list = ls())
setwd("C:/Users/kevin/Desktop/NBCF4DTIPred-master/sim_Dice/")
...
## revision
load("hao_smoothing.FALSE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice <- res4plot

## dthybrid
load("hao_dthybrid.RData")
res4plot_dthybrid <- res4plot

hao <- rbind(res4plot_PPMI, res4plot_cosine, res4plot_tanimoto, res4plot_dice, res4plot_dthybrid)
###
...
## revision, adding dice
load("kuang_smoothing.FALSE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice <- res4plot
...
kuang <- rbind(res4plot_PPMI, res4plot_cosine, res4plot_tanimoto, res4plot_dice, res4plot_dthybrid)
###
...
## revision, adding dice
load("e_smoothing.FALSE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice <- res4plot
...
yaman <- rbind(res4plot_PPMI, res4plot_cosine, res4plot_tanimoto, res4plot_dice, res4plot_dthybrid)
###
...
## revision, adding dice
load("hao_smoothing.FALSE_isLowRankApprox.TRUE_dice.RData")
res4plot_dice_svd <- res4plot

## dthybrid
load("hao_dthybrid.RData")
res4plot_dthybrid <- res4plot

hao_svd <- rbind(res4plot_PPMI_svd, res4plot_cosine_svd, res4plot_tanimoto_svd, res4plot_dice_svd, res4plot_dthybrid)
###
...
## revision, adding dice
load("kuang_smoothing.FALSE_isLowRankApprox.TRUE_dice.RData")
res4plot_dice_svd <- res4plot
...
kuang_svd <- rbind(res4plot_PPMI_svd, res4plot_cosine_svd, res4plot_tanimoto_svd, res4plot_dice_svd, res4plot_dthybrid)
###
...
## revision, adding dice
load("e_smoothing.FALSE_isLowRankApprox.TRUE_dice.RData")
res4plot_dice_svd <- res4plot
...
yaman_svd <- rbind(res4plot_PPMI_svd, res4plot_cosine_svd, res4plot_tanimoto_svd, res4plot_dice_svd, res4plot_dthybrid)
###
...
## revision, adding dice
load("hao_smoothing.TRUE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice_smooth <- res4plot

## dthybrid
load("hao_dthybrid.RData")
res4plot_dthybrid <- res4plot

hao_smooth <- rbind(res4plot_PPMI_smooth, res4plot_cosine_smooth, res4plot_tanimoto_smooth, res4plot_dice_smooth, res4plot_dthybrid)
###
...
## revision, adding dice
load("kuang_smoothing.TRUE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice_smooth <- res4plot
...
kuang_smooth <- rbind(res4plot_PPMI_smooth, res4plot_cosine_smooth, res4plot_tanimoto_smooth, res4plot_dice_smooth, res4plot_dthybrid)
###
...
## revision, adding dice
load("e_smoothing.TRUE_isLowRankApprox.FALSE_dice.RData")
res4plot_dice_smooth <- res4plot
...
yaman_smooth <- rbind(res4plot_PPMI_smooth, res4plot_cosine_smooth, res4plot_tanimoto_smooth, res4plot_dice_smooth, res4plot_dthybrid)
###
...
boxplot(MPR ~ alg, data = hao, col = "lightgray", 
        xaxt = "n")
text(1:5, y = 0.0290, 
     labels = c("PPMI", "Cosine", "Tanimoto", "Dice", "DT-Hybrid"), 
     srt = 45, 
     adj = 1, 
     xpd = TRUE)
